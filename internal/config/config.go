...
func (c *Config) Flat() map[string]string {
	...
	put("editor.vault", c.Editor.Vault)
	...
	put("files.binary_open", c.Files.BinaryOpen)
	...
	put("layout.pane_slots", strings.Join(c.Layout.PaneSlots, ","))
	...
	put("terminal.popup_scope", c.Terminal.PopupScope)
	...
	put("preview.html_open_mode", c.Preview.HTMLOpenMode)
	...
	put("palette.hint_keybind", c.Palette.HintKeybind)
