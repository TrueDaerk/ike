...
func BasePages(themes, lightThemes, darkThemes []string, extraThemes ...theme.Theme) []Page {
	...
	return []Page{
		...
		{Title: "Markdown Preview", Description: "The rendered markdown and HTML preview panes: how the diagram fences inside a document — ```mermaid blocks in READMEs and design docs — are drawn, and whether an HTML page's local images show inline.", Entries: []Entry{
