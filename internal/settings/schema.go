...
func BasePages(themes, lightThemes, darkThemes []string, extraThemes ...theme.Theme) []Page {
	...
	return []Page{
		...
		{Title: "Playgrounds", Description: "The buffer playgrounds (#1936/#2039/#2414): live jq, yq and xmq query lines over the focused document. jq and yq run in-process; the xmq playground shells out to the xmq CLI (github.com/libxmq/xmq).", Entries: []Entry{
		...
		{Title: "Markdown Preview", Description: "The rendered markdown preview pane (#62): how the diagram fences inside a document — ```mermaid blocks in READMEs and design docs — are drawn (#2421).", Entries: []Entry{
		...
		{Title: "Diff Viewer", Description: "The diff pane (#60, 0340): where a diff-open lands in the layout, how much unchanged context it keeps around a change, and whether it compares whitespace at all. The last two are starting points — c/o expand context and w flips whitespace handling on the open diff; the toggle writes its new state back here.", Entries: []Entry{
