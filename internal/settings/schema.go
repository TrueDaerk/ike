...
func BasePages(themes, lightThemes, darkThemes []string, extraThemes ...theme.Theme) []Page {
	...
	return []Page{
		...
		{Title: "Forge", Description: "The code forge behind the Issues tool window (GitHub through gh, Gitea/Forgejo through tea): how often IKE re-reads it in the background, and whether it does so at all while nobody is looking.", Entries: []Entry{
