...
func Defaults() []Menu {
	return []Menu{
		{Title: "File", Items: []Item{
			...
			{Title: "Close Other Tabs", Command: "editor.tab.closeOthers"},
		...
		{Title: "Tools", Items: []Item{
			...
			{Title: "Pin Popup Terminal", Command: "terminal.popup.pin"},
			...
			{Title: "xmq Playground…", Command: "xml.xmqPlayground"},
			{Title: "xmq Playground at Element XPath…", Command: "xml.xmqPlaygroundAtPath"},
			{Title: "Saved xmq Filters…", Command: "xml.xmqFilters"},
			{Title: "Rename Saved xmq Filter…", Command: "xml.xmqRenameFilter"},
			{Title: "jq Cheatsheet…", Command: "json.jqCheatsheet"},
			{Title: "yq Cheatsheet…", Command: "yaml.yqCheatsheet"},
			{Title: "xmq Cheatsheet…", Command: "xml.xmqCheatsheet"},
