...
var noCounterpart = map[string]string{
	...
	"scratch.newFromSelection": "IKE-only concept (#2339): JetBrains' NewScratchFile always opens an empty scratch, with no seed-from-selection action",
	"scratch.promote":          "IKE-only concept (#2339): JetBrains moves a scratch out of the store by drag or Move refactoring, not a keymap action",
