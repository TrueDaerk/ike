...
var noCounterpart = map[string]string{
	...
	"project.findInGroup":              "IKE-only concept (#2575): JetBrains has no named project sets to restrict a search to",
	"project.group.open":               "IKE-only concept (#2571): JetBrains opens one project per window, it has no named project sets",
	"project.group.close":              "IKE-only concept (#2572): closing a named project set has no JetBrains action",
	"project.group.next":               "IKE-only concept (#2572): JetBrains cycles windows, not members of a project set",
	"project.group.prev":               "IKE-only concept (#2572): JetBrains cycles windows, not members of a project set",
	...
	"project.switchMRU1":               "IKE-only concept (#2489): JetBrains' Recent Projects popup has no numbered direct-switch actions",
	"project.switchMRU2":               "IKE-only concept (#2489): JetBrains' Recent Projects popup has no numbered direct-switch actions",
	"project.switchMRU3":               "IKE-only concept (#2489): JetBrains' Recent Projects popup has no numbered direct-switch actions",
	"project.switchMRU4":               "IKE-only concept (#2489): JetBrains' Recent Projects popup has no numbered direct-switch actions",
	"project.switchMRU5":               "IKE-only concept (#2489): JetBrains' Recent Projects popup has no numbered direct-switch actions",
	"project.switchMRU6":               "IKE-only concept (#2489): JetBrains' Recent Projects popup has no numbered direct-switch actions",
	"project.switchMRU7":               "IKE-only concept (#2489): JetBrains' Recent Projects popup has no numbered direct-switch actions",
	"project.switchMRU8":               "IKE-only concept (#2489): JetBrains' Recent Projects popup has no numbered direct-switch actions",
	"project.switchMRU9":               "IKE-only concept (#2489): JetBrains' Recent Projects popup has no numbered direct-switch actions",
	...
	"terminal.popup.pin":               "IKE-only concept (#2406): JetBrains tool windows dock, they have no pinned quake terminal",
