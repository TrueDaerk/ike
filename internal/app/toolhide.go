...
func isToolKind(k pane.Kind) bool {
	switch k {
	case pane.KindExplorer, pane.KindTerminal, pane.KindVCS, pane.KindDebug, pane.KindProblems, pane.KindStructure, pane.KindUsages, pane.KindHTTP, pane.KindBreakpoints, pane.KindTests, pane.KindIssues, pane.KindDOM, pane.KindDoctor:
		return true
	}
	return false
}
