...
func (st *snapState) leafIdentity(key string) (string, paneIdentity, bool) {
	...
	case pane.KindEditor, pane.KindMarkdown, pane.KindHTMLPreview, pane.KindImage, pane.KindDiff, pane.KindMerge, pane.KindArchive, pane.KindData, pane.KindHex, pane.KindNotebook, pane.KindES, pane.KindRemote:
...
func (m *Model) graftImplicit(newTree, liveClone layout.Node, st *applyState) layout.Node {
	...
	graftable := func(key string) bool {
		...
		switch inst.Kind() {
		case pane.KindEditor, pane.KindMarkdown, pane.KindHTMLPreview, pane.KindImage, pane.KindDiff,
...
func identityMatches(id paneIdentity, inst *pane.Instance) bool {
	...
	case "editor":
		...
		switch inst.Kind() {
		case pane.KindMarkdown, pane.KindHTMLPreview, pane.KindImage, pane.KindDiff, pane.KindMerge,
