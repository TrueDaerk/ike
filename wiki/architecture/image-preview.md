...
(see [pane layout](./pane-layout.md)) — or opens as a content tab in the
focused pane when the open came from the palette (#1825, see
[data viewer](./data-viewer.md)) — refocusing an existing pane already
